...
function() {
    ...
    a.prototype.extendDownScroll = function(b) {
        a.extend(b, {
            ...
            textInOffset: "下拉刷新",
            textOutOffset: "释放更新",
            textLoading: "<i class='weui-loading'></i>拼命加载中...",
    ...
    a.prototype.extendUpScroll = function(b) {
        ...
        a.extend(b, {
            ...
            htmlLoading: '<p class="upwarp-progress mescroll-rotate"></p><p class="upwarp-tip"><i class="weui-loading"></i>拼命加载中..</p>',
            htmlNodata: '<p class="upwarp-nodata">真棒！您已经看完了～</p>',
            inited: function(d, e) {},
    ...
    a.prototype.showTopBtn = function(c) {
        if (!this.topBtnShow) {
            ...
            if (d.toTopBtn == null) {
                ...
                if (e.supportTap) {
                    d.toTopBtn.addEventListener("tap",
                    function(g) {
                        g.stopPropagation();
                        d.preventDefault(g);
